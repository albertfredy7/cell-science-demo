...
const styles = {
  typography: {
    base: [
      ...
      "[&_h1]:text-4xl [&_h1]:font-normal [&_h1]:tracking-tight",
      "[&_h2]:text-3xl [&_h2]:font-normal [&_h2]:tracking-tight",
      "[&_h3]:text-2xl [&_h3]:font-normal [&_h3]:tracking-tight",
      "[&_h4]:text-xl [&_h4]:font-normal [&_h4]:tracking-tight",
      "[&_h5]:text-lg [&_h5]:font-normal [&_h5]:tracking-tight",
      "[&_h6]:text-base [&_h6]:font-normal [&_h6]:tracking-tight",
      // Text elements
      "[&_p]:text-xl [&_p]:leading-7 [&_p]:mb-4 font-normal",
      "[&_strong]:font-medium [&_strong]:text-2xl",
      "[&_em]:italic",
      "[&_del]:line-through",
    ...
    lists: [
      // Unordered lists
      "[&_ul]:pl-0 [&_ul]:list-none [&_ul]:space-y-2 [&_ul]:text-xl",
      "[&_ul_li]:relative [&_ul_li]:pl-6 [&_ul_li]:text-xl",
      ...
      // Ordered lists
      "[&_ol]:list-decimal [&_ol]:pl-6 [&_ol]:space-y-2 [&_ol]:text-xl",
      "[&_ol_ol]:list-[lower-alpha] [&_ol_ol]:pl-6 [&_ol_ol]:text-xl",
      "[&_ol_ol_ol]:list-[lower-roman] [&_ol_ol_ol]:pl-6 [&_ol_ol_ol]:text-xl",
      // List item styles
      "[&_li]:pl-2 [&_li]:text-xl",
      ...
      // Task lists
      "[&_li]:has([type=checkbox]):pl-8 [&_li]:has([type=checkbox]):text-xl",
      ...
      // Mixed lists
      "[&_ol_ul]:pl-6 [&_ol_ul]:text-xl",
      "[&_ul_ol]:pl-6 [&_ul_ol]:text-xl",
    ],
