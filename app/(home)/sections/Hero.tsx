        ...
        <section className="relative min-h-svh  overflow-hidden flex flex-col">
            ...
            <div className="flex-1 w-full pt-16 xs:pt-20 sm:pt-24 lg:pt-28 mx-auto flex flex-col ">
                <div className="flex-1 lg:grid grid-cols-2 z-20 ">
                    ...
                    <BlurIn delay={0.4} duration={1.6}>
                        <div className="h-full p-4 sm:p-6 md:p-8 lg:p-10 2xl:ps-36 lg:text-left text-center pt-[16%] md:pt-20 lg:pt-0 space-y-2 ">
                            <span className="text-2xl sm:text-2xl md:text-2xl lg:text-3xl xl:text-3xl 2xl:text-4xl max-w-md inline-block">
                                <h1 className="md:w-full  max-w-64 md:max-w-lg xl:max-w-md">
                                    You are unique and your body is made of trillions of
                                </h1>
                                <GradientText className="w-full flex justify-center lg:justify-start">
                                    intelligent cells.
                                </GradientText>
                            </span>
                    ...
                    <div className="  absolute right-0 bottom-0 hidden w-full lg:flex items-end  justify-end xl:pr-[1%] xl:pb-[4%] px-4 sm:px-6 md:px-8 lg:px-0 pb-10 ">
                        <BlurIn delay={1.5} duration={1}>
                            <div className="space-y-2 mx-auto lg:float-end pt-10 lg:pt-10 2xl:pt-16  max-w-sm md:max-w-md lg:max-w-md text-center lg:text-left   ">
                                <GradientText>
            ...
            <div className="absolute bottom-0 left-0 right-0 mx-auto w-full">
                <BlurIn delay={0} blur="8px" duration={1}>
                    <div className="relative h-[50vh] sm:h-[55vh] md:h-[60vh] lg:h-[70vh] xl:h-[75vh] 2xl:h-[80vh] max-w-[95%] sm:max-w-[90%] md:max-w-[80%] lg:max-w-[70%] mx-auto">
                        <Image
                            src="/hero.webp"
                            alt="hero"
                            fill
